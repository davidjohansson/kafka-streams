 ...
 */
public class MoistAverage {

    public static void main(String[] args) throws Exception {
        Properties props = new Properties();
        props.put(StreamsConfig.APPLICATION_ID_CONFIG, "most-avg");
...
/*        KStreamBuilder builder = new KStreamBuilder();
        ...
        builder.stream("most-trans")

                .groupByKey(Serdes.String(), Serdes.Integer())
                .count(JoinWindows.of(1000))
                .to(Serdes.String(), Serdes.Integer(), "most-trans-2");
