 ...
 */
public class MoistToPercent {

    public static void main(String[] args) throws Exception {
        Properties props = new Properties();
        props.put(StreamsConfig.APPLICATION_ID_CONFIG, "moist-raw");
        ...
        KStream<String, String> source = builder.stream("moist-raw");

        KTable<String, String> counts =
                source
                        .map((KeyValueMapper<String, String, KeyValue<K1, V1>>) (key, value) -> System.out.println())
